...
public class EvenliDivisible {

        public static void main(String[] args) {

            int number = 65;

            boolean divisibleBy2 =  number % 2 == 0; // if the remainder of
            // a number divided by 2 is zero, then it's evenly divisible by 2
...
and write a program that can check
